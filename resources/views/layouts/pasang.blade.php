    ...
    <div class="modal fade" id="modalPop" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-notify modal-info" role="document">
            <div class="modal-content text-center">
                ...
                <!-- menambahkan popup untuk mengarah ke whatsapp -->
                <div class="modal-body">

                    <a role="button" href="https://wa.me/6287719999132/?text=Halo!+Ada+yang+bisa+dibantu?" style="text-decoration: none">
                        <img src="https://www.lokerjogja.id/wp-content/themes/lokerjogjav1/img/pasang/whatsapp.png" width="70" height="70">
                        <hr style="opacity: 0%">
                        <h2 style="text-decoration: none">Via Whatsapp</h2>
                        <hr>
                        <h4 style="font-size: small">Tim kami akan memberikan bantuan pemasangan melalui aplikasi Whatsapp</h4>
                    </a>
                    <!-- selesai -->
